...
#         Explanation: record starting with any number from 1 to any, ending with a comma. (the comma is escaped)
#
#       B)
#         RECORD FORMAT = "ABC456|David Garcia|Some data"
#         COMMAND = fixlinefeeds.sh someFile.txt "[A-Z]\{1,3\}[0-9]\{1,\}|" 
#         Explanation: record starting with any uppercase letters from 1 to 3 characters and any number from 1 to any, ending with a pipe.
# 
################################################################################
